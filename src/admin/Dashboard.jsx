...
export default function Dashboard() {
  ...
  return (
    <div>
      <h1 className="font-serif text-3xl font-bold text-ink-800 mb-2">Dashboard</h1>
      <p className="text-ink-600 mb-8">Manage website content, blog posts, and appearance.</p>
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {cards.map((card) => (
          ...
          >
            <card.icon size={20} className="text-ink-700 mb-3" />
            <div className="text-2xl font-bold text-ink-800">{card.value}</div>
